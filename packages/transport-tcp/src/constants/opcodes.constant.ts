...
import type { ValueOf, FlipObject } from '@agnoc/toolkit';
...
export const OPCODES = {
  ...
  DEVICE_SETTIME_REQ: 0x100f,
  DEVICE_SETTIME_RSP: 0x1010,
  ...
  DEVICE_MOP_FLOOR_CLEAN_REQ: 0x107d,
  DEVICE_MOP_FLOOR_CLEAN_RSP: 0x107e,
  ...
  DEVICE_MAPID_SET_HISTORY_MAP_ENABLE_REQ: 0x1105,
  DEVICE_MAPID_SET_HISTORY_MAP_ENABLE_RSP: 0x1106,
...
type OPCodeMap = typeof OPCODES;

export type OPNameLiteral = keyof OPCodeMap;
export type OPCodeFrom<Name extends OPNameLiteral> = OPCodeMap[Name];
export type OPCodeLiteral = ValueOf<OPCodeMap>;
export type OPNameFrom<Code extends OPCodeLiteral> = FlipObject<OPCodeMap>[Code];
